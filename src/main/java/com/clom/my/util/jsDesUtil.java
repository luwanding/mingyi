...
/**
 * Created by clovermmmmmmmmmmmmm on 2017/12/20 0020.
 * 用于和前台js进行一个加密解密的方法
 *
 */
...
public class jsDesUtil {
    public static void main(String[] args) {
        jsDesUtil desObj = new jsDesUtil();
        String key1 = "%!##@$%|$#$%(^)$}$*{^*+%";
        String key2 = "";
        String key3 = "";
        String data = "luwanding";
        String str = desObj.strEnc(data, key1);
        System.out.println(str);
        String dec = desObj.strDec("EE60AE20C4E84A41", key1);
